    ...
    function getOptions() {
        ...
        return array(
            ...
            'dsf'                    => new SectionBreakField(
                    array(
                'label' => $__('Deletion Options')
                    )),
            'strip-metadata'         => new BooleanField(
                    array(
                'default' => FALSE,
                'hint'    => $__('Cleans up replies to tickets, removes metadata from users messages.'),
                'label'   => $__('Remove Metadata from replies')
                    )
            ),
